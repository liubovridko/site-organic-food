...
$sql = "SELECT * FROM comments"; //выбрать все из базы данных users
...
?>
 <div class="content-page">
	...
	/*проверка если массив GET параметров  пустой -выводим страницу all*/
	          if(empty($_GET)){
	           require ($_SERVER['DOCUMENT_ROOT'] . '/admin/modules/comments/all-comments.php');
	        } else {
	            
	            /*или если есть GET с параметром page- в случаи edit-выводим страницу /edit.php*/
	           switch ($_GET['page']) {
	               case 'edit':
	                   require ($_SERVER['DOCUMENT_ROOT'] . '/admin/modules/comments/edit.php');
	                   break;
	               case 'add':
