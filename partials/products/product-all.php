...
<?php
  ...
  $sql = "SELECT * FROM products";
   ...
   if($result = mysqli_query($conn, $sql)):  /*при успешном выполнении команды SELECT возвращает набор строк, который можно перебрать с помощью цикла*/
    ...
    /*1. Зробити посилання на лайк(окрема сторінка, на яку ми будемо посилатися за допомогою ajax)
      2. Зробити перевірку чи є запис в базі даних з даним постом  і користувачем 
