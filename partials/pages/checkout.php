      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="/?page=home">Home</a></span> <span>Checkout</span></p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="partials/products/add-order.php" method="POST" class="billing-form">
	          	...
	          	<div class="col-md-12">
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<p>
										<input type="submit" name="" class="btn btn-primary py-3 px-4" placeholder="Place an order" > </p>
								</div>
	          	</div>
	          	  </form><!-- END -->
	          </div>
